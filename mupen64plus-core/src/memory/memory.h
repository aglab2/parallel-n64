...
#define mupencoreaddress (*(uint32_t*)(((char*)base_addr)+33554720))
#define cpu_word         (*(uint32_t*)(((char*)base_addr)+33554744))
#define cpu_byte         (*(uint8_t*) (((char*)base_addr)+33554750))
#define cpu_hword        (*(uint16_t*)(((char*)base_addr)+33554748))
#define cpu_dword        (*(uint64_t*)(((char*)base_addr)+33554736))
#endif
